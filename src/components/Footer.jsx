    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full
     overflow-hidden'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-center '>
        ...
        <img src={assets.logo} width={80} alt="" />
        <p className='text-white text-3xl font-semibold'>Estate</p>
        </div>
        ...
        <div className='w-full md:w-1/5 mb-8 md:mb-0'>
            ...
            <ul className='flex flex-col gap-2 text-gray-400'>
                <a href="#Header"
                 ...
                 <a href="#About"
                 className='hover:text-white'>About</a>
                 <a href="#Contact"
      ...
      <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>Copyright {new Date().getFullYear()} &copy; EyohTech. All Right Reservred. </div>
    </div>
  );
}
