...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", '69101171-09ac-4e03-abdd-fe2654ee9cd9');
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      <h1 className='text-24 sm:text-4xl font-bold mb-2 text-center'>Contact <span className='underline
      ...
      <form onSubmit={onSubmit}  className='max-w-2xl mx-auto text-gray-600 pt-8' >
        ...
        <div className='my-6 text-left'>
            ...
            px-4 mt-2 resize-none'
            name="Message" placeholder='Message' rows={6} required></textarea>
        </div>
